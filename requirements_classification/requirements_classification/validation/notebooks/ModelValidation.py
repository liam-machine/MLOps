...
#
# It runs as part of CD and by an automated model training job -> validation -> deployment job defined under ``requirements_classification/resources/model-workflow-resource.yml``
#
#
# Parameters:
#
...
# * custom_metrics_loader_function          - Specifies the name of the function in requirements_classification/validation/validation.py that returns custom metrics.
# * validation_thresholds_loader_function   - Specifies the name of the function in requirements_classification/validation/validation.py that returns model validation thresholds.
#
...
dbutils.widgets.text(
    "experiment_name",
    "/dev-requirements_classification-experiment",
    "Experiment Name",
)
...
dbutils.widgets.text("model_name", "dev.requirements_classification.requirements_classification-model", "Full (Three-Level) Model Name")
