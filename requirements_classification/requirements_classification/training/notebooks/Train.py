...
# ``requirements_classification/resources/model-workflow-resource.yml``
#
# Parameters:
...
dbutils.widgets.text(
    "experiment_name",
    f"/dev-requirements_classification-experiment",
    label="MLflow experiment name",
)
# Unity Catalog registered model name to use for the trained model.
dbutils.widgets.text(
    "model_name", "dev.requirements_classification.requirements_classification-model", label="Full (Three-Level) Model Name"
)
