...
Opening a pull request will trigger a[workflow](../.github/workflows/requirements_classification-run-tests.yml) 
...
Links:
* [Staging model in UC](https://dbc-9cafe583-f02f.cloud.databricks.com/explore/data/models/staging/requirements_classification/requirements_classification-model)
* [Prod model in UC](https://dbc-65a36781-206e.cloud.databricks.com/explore/data/models/prod/requirements_classification/requirements_classification-model)
. 
