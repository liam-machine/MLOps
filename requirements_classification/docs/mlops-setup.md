...
git add README.md docs .gitignore requirements_classification/resources/README.md
...
* You must be a Databricks workspace admin in the staging and prod workspaces. Verify that you're an admin by viewing the
  [staging workspace admin console](https://dbc-9cafe583-f02f.cloud.databricks.com#setting/accounts) and
  [prod workspace admin console](https://dbc-65a36781-206e.cloud.databricks.com#setting/accounts). If
...
If you want to use different catalog names, please update the target names declared in the[requirements_classification/databricks.yml](../requirements_classification/databricks.yml) file.
...
Follow the instructions in [requirements_classification/resources/README.md](../requirements_classification/resources/README.md) to deploy ML resources
and production jobs.
...
[ML resource config guide](../requirements_classification/resources/README.md)  to propose, test, and deploy
